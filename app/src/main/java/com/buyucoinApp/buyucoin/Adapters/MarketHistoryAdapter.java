...
//            holder.type_img.setImageTintList(ColorStateList.valueOf(context.getResources().getColor(R.color.kyc_color)));
            holder.price.setTextColor(context.getResources().getColor(R.color.bids_color));
            holder.value.setTextColor(context.getResources().getColor(R.color.bids_color));
            holder.amount.setTextColor(context.getResources().getColor(R.color.bids_color));
            holder.type.setTextColor(context.getResources().getColor(R.color.bids_color));
        }else{
