...
public class MyHistoryDepositeRecyclerViewAdapter extends RecyclerView.Adapter<MyHistoryDepositeRecyclerViewAdapter.ViewHolder> {

    private final ArrayList<History> mValues;
    private Context context;
    private FragmentManager fragmentManager;

    public MyHistoryDepositeRecyclerViewAdapter(ArrayList<History> items,Context context,FragmentManager fragmentManager) {
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, int position) {
        try {
            ...
            if(!holder.mItem.getOpen().equals("")){ holder.mOpenTime.setText(holder.mItem.getOpen()); }
